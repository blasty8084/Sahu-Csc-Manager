...
import { TrendingUp, TrendingDown, Wallet, Receipt, ChevronRight, X } from "lucide-react";
  ...
  return (
    <Layout>
      <div className="space-y-5">
        <div>
          <h2 className="text-xl font-bold">Users Cash Overview</h2>
          <p className="text-sm text-muted-foreground">Each user's separate ledger balance and activity</p>
        </div>
