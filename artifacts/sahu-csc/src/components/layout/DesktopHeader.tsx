      ...
      <div className="flex items-center justify-between px-8" style={{ height: 64, position: "relative", zIndex: 2 }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 5, transition: "opacity 0.35s ease, transform 0.35s ease", opacity: greetingVisible ? 1 : 0, transform: greetingVisible ? "translateY(0)" : "translateY(3px)" }}>
            ...
            <span style={{ fontSize: 12, color: "var(--color-slate-400)" }}>·</span>
            <span style={{ fontSize: 12, color: "var(--color-slate-400)", fontWeight: 400 }}>{shortDate}</span>
            <span style={{ fontSize: 12, color: "var(--color-slate-400)" }}>·</span>
            <LiveClock style={{ fontSize: 11, fontWeight: 700, fontFamily: "monospace", letterSpacing: "0.05em", background: "linear-gradient(135deg, var(--brand-navy-800), var(--brand-orange))", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }} />
          </div>
        </div>
            ...
            >
              {avatarSrc ? (
                ...
                <div
                  ...
                  style={{ width: 28, height: 28, background: "linear-gradient(135deg, var(--brand-navy-800) 0%, var(--brand-navy-500) 55%, var(--brand-orange) 100%)", color: "#fff", fontSize: 10, fontWeight: 900 }}
                >
                  {initials}
                </div>
              )}
