...
export function AepsReceiptActions({
  ...
  const buttons = [
    { key: "print",     icon: Printer,       label: "Print",                        onClick: onPrint,       disabled: false,         color: "#475569", isWhatsApp: false },
    { key: "pdf",       icon: Download,      label: generatingPdf ? "…" : "PDF",   onClick: onDownloadPdf, disabled: generatingPdf, color: "#0b2c60", isWhatsApp: false },
    { key: "whatsapp",  icon: MessageCircle, label: sendingWa ? "…" : "WhatsApp",  onClick: onWhatsApp,    disabled: sendingWa,     color: "#22c55e", isWhatsApp: true  },
    { key: "share",     icon: Share2,        label: "Share",                        onClick: onShare,       disabled: false,         color: "#f97316", isWhatsApp: false },
  ];
