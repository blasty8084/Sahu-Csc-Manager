  ...
  return (
    <>
      ...
      <div style={{ padding: "18px 22px 14px", textAlign: "center", position: "relative" }}>
        ...
        <p style={{ fontSize: 9, color: "var(--color-slate-400)", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", marginBottom: 8, position: "relative" }}>{txLabel} Amount</p>
      ...
      <div style={{ margin: "0 16px 14px", display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div>
          <p style={{ fontSize: 11, fontWeight: 700, color: "var(--brand-navy-800)", marginBottom: 4 }}>{hasToken ? "Scan to open & download" : "Scan for details"}</p>
          <p style={{ fontSize: 9, color: "var(--color-slate-400)", lineHeight: 1.6 }}>{hasToken ? "Scan QR to open receipt online and download the PDF." : "Scan to view transaction details."}</p>
        </div>
      </div>
    </>
  );
