...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const sharedProps = { mainNavItems, adminNavItems, initials, avatarSrc, displayName, roleLabel, onLogout: handleLogout };
  ...
  return (
    <div className="min-h-screen bg-muted/20 flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col md:ml-64">
        ...
        <DesktopHeader unreadCount={unreadCount} initials={initials} avatarSrc={avatarSrc} firstName={firstName} />
