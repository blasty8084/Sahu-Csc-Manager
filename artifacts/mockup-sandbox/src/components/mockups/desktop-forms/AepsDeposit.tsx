import { X, ArrowUpRight, IndianRupee, User, Fingerprint, Building2, Hash, FileText, Eye, CheckCircle2 } from "lucide-react";

const navy = "#0b2c60";
const saffron = "#f97316";
const accentColor = "#059669";
const accent = "linear-gradient(135deg,#10b981,#059669)";
const accentLight = "rgba(16,185,129,0.07)";
const accentBorder = "rgba(16,185,129,0.22)";

const BANKS = ["SBI", "Bank of Baroda", "PNB", "Union Bank", "Canara Bank", "HDFC Bank"];
const QUICK = [500, 1000, 2000, 5000, 10000];

export function AepsDeposit() {
  return (
    <div style={{ width: "100vw", height: "100vh", background: "#f0f4fa", display: "flex", overflow: "hidden", position: "relative", fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <div style={{ position: "absolute", right: 0, top: 0, height: "100%", width: 560, background: "#fff", zIndex: 20, boxShadow: "-16px 0 60px rgba(11,44,96,0.22)", display: "flex", flexDirection: "column", overflow: "hidden" }}>
        {/* Accent stripe */}
        <div style={{ height: 4, background: "linear-gradient(90deg,#10b981,#059669)", flexShrink: 0 }} />
        ...
        <div style={{ background: `linear-gradient(135deg,${navy} 0%,#0f3872 60%,#1a4a9e 100%)`, padding: "18px 28px 14px", flexShrink: 0, position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
            <div>
              ...
              <h2 style={{ color: "#fff", fontSize: 20, fontWeight: 900, lineHeight: 1.1, marginTop: 2 }}>New AePS Deposit</h2>
            </div>
          ...
          <div style={{ display: "flex", borderRadius: 16, overflow: "hidden", background: "rgba(255,255,255,0.10)", padding: 4, gap: 4 }}>
            <button style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, padding: "9px 0", borderRadius: 12, fontWeight: 800, fontSize: 13, border: "none", cursor: "pointer", background: "transparent", color: "rgba(255,255,255,0.48)" }}>
              <ArrowUpRight size={14} style={{ transform: "rotate(180deg)" }} /> Withdrawal
            </button>
            <button style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, padding: "9px 0", borderRadius: 12, fontWeight: 800, fontSize: 13, border: "none", cursor: "pointer", background: "linear-gradient(135deg,#10b981,#059669)", color: "#fff", boxShadow: "0 3px 10px rgba(16,185,129,0.45)" }}>
          ...
          <div style={{ background: "#fff", borderRadius: 16, overflow: "hidden", boxShadow: "0 2px 12px rgba(11,44,96,0.08)", border: "1px solid rgba(11,44,96,0.06)" }}>
            ...
            <div style={{ padding: "16px 20px" }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input readOnly value="2000" style={{ width: "100%", height: 58, paddingLeft: 62, paddingRight: 16, borderRadius: 14, border: `2px solid ${accentColor}`, fontSize: 28, fontWeight: 900, color: navy, outline: "none", boxSizing: "border-box", background: accentLight }} />
              </div>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginTop: 12 }}>
                {QUICK.map(v => (
                  <button key={v} style={{ padding: "7px 14px", borderRadius: 10, fontSize: 12, fontWeight: 700, background: v === 2000 ? accent : "#f1f5f9", color: v === 2000 ? "#fff" : "#64748b", border: v === 2000 ? "none" : "1px solid #e2e8f0", cursor: "pointer" }}>
                    ₹{v >= 1000 ? v / 1000 + "K" : v}
                  </button>
                ))}
              </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input readOnly value="Priya Devi" style={{ width: "100%", height: 46, paddingLeft: 34, paddingRight: 12, borderRadius: 13, border: `1.5px solid rgba(11,44,96,0.25)`, fontSize: 13, fontWeight: 600, color: navy, outline: "none", background: "rgba(11,44,96,0.03)", boxSizing: "border-box" }} />
              </div>
            </div>
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input readOnly value="XXXX XXXX 7890" style={{ width: "100%", height: 46, paddingLeft: 34, paddingRight: 36, borderRadius: 13, border: `1.5px solid rgba(11,44,96,0.25)`, fontSize: 13, fontWeight: 700, color: navy, outline: "none", background: "rgba(11,44,96,0.03)", boxSizing: "border-box", fontFamily: "monospace", letterSpacing: "0.06em" }} />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <select style={{ width: "100%", height: 46, paddingLeft: 34, paddingRight: 12, borderRadius: 13, border: `1.5px solid rgba(11,44,96,0.25)`, fontSize: 13, fontWeight: 600, color: navy, outline: "none", background: "rgba(11,44,96,0.03)", appearance: "none", boxSizing: "border-box" }}>
            ...
            <div>
              <p style={{ fontSize: 10, fontWeight: 700, color: "#94a3b8", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 8 }}>Account No <span style={{ fontWeight: 400, textTransform: "none", color: "#cbd5e1" }}>(opt.)</span></p>
              <div style={{ position: "relative" }}>
                <Hash size={13} style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: "#94a3b8" }} />
                <input readOnly value="XX3456789" style={{ width: "100%", height: 46, paddingLeft: 34, paddingRight: 12, borderRadius: 13, border: "1.5px solid #e2e8f0", fontSize: 13, fontWeight: 600, color: navy, outline: "none", background: "#fff", boxSizing: "border-box", fontFamily: "monospace", letterSpacing: "0.05em" }} />
              </div>
            </div>
          </div>
        ...
        <div style={{ padding: "16px 28px 28px", borderTop: "1px solid #f1f5f9", background: "#fff", flexShrink: 0, display: "flex", gap: 12 }}>
          ...
          <button style={{ flex: 2, height: 52, borderRadius: 16, border: "none", cursor: "pointer", background: accent, color: "#fff", fontSize: 15, fontWeight: 900, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, boxShadow: `0 6px 20px ${accentColor}30` }}>
            <CheckCircle2 size={16} /> Review Deposit
          </button>
        </div>
      </div>
    </div>
