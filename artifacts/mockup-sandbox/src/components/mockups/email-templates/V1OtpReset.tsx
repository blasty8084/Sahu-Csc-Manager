    ...
    <div className="min-h-screen bg-[#eef2f7] flex items-center justify-center py-10 px-4 font-sans">
      <div style={{ maxWidth: '560px', width: '100%', backgroundColor: '#ffffff', borderRadius: '18px', overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.08)', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
        <div style={{ backgroundColor: '#0b2c60', padding: '40px 24px', textAlign: 'center', color: '#ffffff' }}>
          ...
          <div style={{ fontSize: '12px', fontWeight: 600, letterSpacing: '1px', color: 'rgba(255,255,255,0.7)', marginBottom: '12px' }}>PASSWORD RESET</div>
        ...
        <div style={{ padding: '36px', color: '#1e293b', fontSize: '16px', lineHeight: '1.6' }}>
          <h1 style={{ fontSize: '22px', fontWeight: 600, color: '#0b2c60', margin: '0 0 16px 0' }}>Password Reset Request</h1>
          <p style={{ margin: '0 0 24px 0' }}>We received a request to reset your SAHU CSC account password. Use the one-time password below to continue.</p>
          ...
          <div style={{ textAlign: 'center', margin: '32px 0' }}>
            ...
            <div>
              <span style={{ display: 'inline-block', padding: '6px 12px', backgroundColor: '#fff7ed', color: '#f97316', fontSize: '12px', fontWeight: 600, borderRadius: '20px', border: '1px solid rgba(249,115,22,0.3)' }}>
                Expires at 11:20 AM · valid for 10 minutes
              </span>
            </div>
          </div>
          
          <div style={{ padding: '16px', backgroundColor: '#fff7ed', borderLeft: '4px solid #f97316', borderRadius: '0 10px 10px 0', fontSize: '14px', color: '#475569' }}>
