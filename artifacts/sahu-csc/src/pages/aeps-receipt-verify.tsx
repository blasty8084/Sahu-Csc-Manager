...
import {
  Download, Printer, Share2, Fingerprint, MapPin, Phone, Globe, AlertCircle, CheckCircle2,
} from "lucide-react";
...
export default function AepsReceiptVerify() {
  ...
  const {
    ...
    operatorName, createdAt, businessName, businessAddress, businessMobile, businessWebsite,
  } = receipt;
    ...
    <div style={{ minHeight: "100vh", background: "#f1f5f9", paddingTop: 32, paddingBottom: 48 }}>
      <div style={{ maxWidth: 440, margin: "0 auto", padding: "0 16px" }}>
        ...
        <div ref={printRef} style={{ background: "#fff", borderRadius: 20, overflow: "hidden", boxShadow: "0 8px 32px rgba(11,44,96,0.12)" }}>
          ...
          {/* Header */}
          <div style={{
            background: isWithdrawal ? "linear-gradient(135deg,#7f1d1d,#e11d48)" : "linear-gradient(135deg,#064e3b,#059669)",
          ...
          {/* Stripe */}
          <div style={{ height: 4, background: isWithdrawal ? "linear-gradient(90deg,#e11d48,#f43f5e,#0b2c60)" : "linear-gradient(90deg,#059669,#10b981,#0b2c60)" }} />
