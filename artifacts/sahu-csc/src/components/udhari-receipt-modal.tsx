...
import { Download, Printer, Share2, MapPin, Phone, Globe, ArrowUpRight, ArrowDownLeft, CheckCircle2, ShieldCheck, MessageCircle } from "lucide-react";
...
export function UdhariReceiptModal({
  ...
  const shortDate = new Date(entry.date + "T00:00:00").toLocaleDateString("en-IN", {
          ...
          <div ref={printRef} style={{ background: "#fff" }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                {isGave
                  ? <ArrowUpRight size={22} color="#fff" strokeWidth={2.5} />
                  : <ArrowDownLeft size={22} color="#fff" strokeWidth={2.5} />}
              </div>
            ...
            <div style={{ margin: "0 16px 14px", display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div>
                ...
                <p style={{ fontSize: 9, color: "#94a3b8", lineHeight: 1.6 }}>
                  {hasToken
                    ? "Scan QR to open receipt online and download PDF."
                    : "Share QR as a payment reminder to the customer."}
                </p>
              </div>
            </div>
