 ...
 */
export function UdhariReceiptActions({ cardRef, receipt, pageUrl }: UdhariReceiptActionsProps) {
  const [generatingPdf, setGeneratingPdf] = useState(false);
  const [sendingWa, setSendingWa] = useState(false);

  const {
    receiptNumber, type, amount, note,
    customerName, customerMobile, currentBalance,
    businessName, businessMobile: bizMobile,
  } = receipt;
