...
export default function ForgotPassword() {
  ...
  // Detect admin-generated reset link (?token=<uuid> in URL)
  useEffect(() => {
                ...
                {adminResetMode && (
                  <div className="mb-4 rounded-xl border border-blue-200 bg-blue-50 px-4 py-3 flex items-start gap-2.5 text-xs text-blue-800">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-blue-700">This link was generated by your administrator and expires in 10 minutes. Set your password now.</p>
                    </div>
                  </div>
                )}
