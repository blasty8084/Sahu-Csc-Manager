    ...
    <div className="relative w-full flex flex-col items-center mt-6 select-none">
      <div className="flex items-end gap-4 mb-0 w-full max-w-xs justify-center">
        <div className="flex flex-col items-center flex-shrink-0">
          ...
          <div className="w-2.5 h-5 rounded-sm" style={{ background: "var(--color-warning-dark)" }} />
        </div>
        <div className="flex flex-col items-center">
          <div className="flex items-end gap-1 mb-0.5">
            <div className="w-0.5 h-10 rounded-full" style={{ background: "rgba(255,255,255,0.5)" }} />
            <div className="w-5 h-3 rounded-sm" style={{ background: "var(--brand-orange-400)" }} />
          </div>
          <div className="w-36 h-5 rounded-t-lg" style={{ background: "var(--brand-navy-650)" }} />
          <div className="w-40 h-20 flex flex-col items-center justify-center gap-1.5" style={{ background: "var(--brand-navy-650)" }}>
            <div className="px-3 py-0.5 rounded text-white text-xs font-black tracking-widest" style={{ background: "var(--brand-orange-tint-md)", border: "1px solid var(--brand-orange-glow)" }}>CSC</div>
            <div className="flex gap-2">
              {[0, 1, 2].map((i) => (
                <div key={i} className="w-5 h-5 rounded-sm" style={{ background: "#0f1a4a", border: "1px solid var(--brand-white-low)" }} />
              ))}
            </div>
          </div>
          <div className="w-10 h-10 rounded-t-full" style={{ background: "var(--brand-orange)" }} />
        </div>
        <div className="flex flex-col items-center flex-shrink-0">
          <div className="w-7 h-9 rounded-full" style={{ background: "linear-gradient(180deg, #166534, #15803d)" }} />
          <div className="w-2 h-4 rounded-sm" style={{ background: "var(--color-warning-dark)" }} />
        </div>
      </div>
      <div className="w-full max-w-xs h-1 rounded-full" style={{ background: "var(--brand-white-mid)" }} />
      <div className="w-full max-w-xs h-2 flex overflow-hidden rounded-b-sm">
        <div className="flex-1" style={{ background: "var(--brand-orange-400)" }} />
        <div className="flex-1 bg-white" />
        <div className="flex-1" style={{ background: "var(--color-success-dim)" }} />
      </div>
    </div>
  );
}
    ...
    <div className="w-[58%] flex flex-col px-12 py-8 overflow-hidden">
      <div className="flex items-center gap-3 flex-shrink-0">
        ...
        <div>
          <div>
            ...
            <span style={{ color: "var(--brand-orange)" }} className="font-black text-lg">CSC</span>
          </div>
      ...
      <div className="flex-1 flex flex-col justify-center min-h-0 mt-6">
        <h1 className="text-4xl font-black leading-tight flex-shrink-0">
          ...
          <br />
          <span style={{ color: "var(--brand-orange)" }}>Many Services.</span>
        </h1>
        ...
        <div className="space-y-3 mt-6 flex-shrink-0">
          {[
            ...
            <div key={title} className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm" style={{ background: "var(--brand-navy-650)", border: "1px solid var(--brand-orange-tint-md)" }}>
...
export function DesktopFooterBar() {
  return (
    <div className="flex-shrink-0" style={{ borderTop: "1px solid var(--brand-navy-650)", background: "#080e2e" }}>
      <div className="flex items-center justify-around py-2.5 px-8 max-w-4xl mx-auto">
        {[
          ...
          <div key={label} className="flex items-center gap-2">
            <Icon className="w-3.5 h-3.5 flex-shrink-0" style={{ color: "var(--brand-orange)" }} />
