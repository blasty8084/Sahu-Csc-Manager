...
import { ShieldCheck, Loader2, CheckCircle2, RefreshCw, XCircle, ArrowLeft } from "lucide-react";
...
/** Step 2 — 6-digit OTP grid with paste support, resend timer, and rate-limit fallback panel. */
export function StepVerifyOtp({ otpRateLimited, rateLimitSeconds, onRateLimitBack, maskedEmail, otpDigits, setOtpDigits, otpRefs, submitting, serverError, setServerError, resendSeconds, onVerifyOtp, onResend, onBack }: StepVerifyOtpProps) {
  ...
  const handleOtpPaste = (e: React.ClipboardEvent) => {
    ...
    if (pasted.length === 6) setTimeout(() => onVerifyOtp(pasted), 80);
  };
