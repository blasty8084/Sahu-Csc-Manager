    ...
    >
      ...
      <div
        style={{
          ...
          overflow: "hidden",
          boxShadow: "0 -8px 40px rgba(11,44,96,0.18)",
        }}
      >
        {/* Drag handle */}
        <div
          ...
          {(["credit", "debit"] as const).map((t) => (
            <button
              ...
              style={{
                ...
                background:
                  type === t ? (t === "credit" ? GREEN : RED) : "transparent",
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              background: "#fafafa",
              fontSize: 14,
              color: service ? NAVY : "#94a3b8",
              outline: "none",
              cursor: "pointer",
              display: "flex",
              alignItems: "center",
              justifyContent: "space-between",
              fontWeight: service ? 600 : 400,
              textAlign: "left",
            }}
          >
          ...
          {serviceOpen && (
            <div
              style={{
                ...
                background: "#fff",
                overflow: "hidden",
                boxShadow: "0 4px 20px rgba(11,44,96,0.1)",
              }}
            >
              {services.map((s) => (
                <button
                  ...
                  style={{
                    ...
                    fontSize: 13,
                    fontWeight: 600,
                    color: s === service ? SAFFRON : NAVY,
                    background:
                      s === service ? "rgba(249,115,22,0.07)" : "transparent",
                    border: "none",
                    cursor: "pointer",
