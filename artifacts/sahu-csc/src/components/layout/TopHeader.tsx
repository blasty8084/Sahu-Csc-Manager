  ...
  return (
    <header className="sticky top-0 z-20 md:hidden">
      ...
      <div style={{ position: "relative", overflow: "hidden", background: "white" }}>
        ...
        {/* Aurora blobs */}
        <div style={{ position: "absolute", top: -20, right: 20, width: 100, height: 100, background: "radial-gradient(circle, var(--brand-orange-tint-sm) 0%, transparent 70%)", filter: "blur(20px)", pointerEvents: "none" }} />
        ...
        <div className="flex items-center justify-between px-4" style={{ height: 60, position: "relative", zIndex: 2 }}>
          ...
          <div className="flex items-center gap-2.5">
            <div style={{ borderRadius: "50%", boxShadow: "0 3px 12px var(--brand-navy-shadow-sm), 0 0 0 1.5px var(--brand-navy-tint-md)", flexShrink: 0 }}>
              <AppLogo size="sm" className="w-10 h-10" />
            </div>
            <div>
              <div className="flex items-baseline gap-1">
                <span style={{ fontSize: 16, fontWeight: 900, letterSpacing: "0.02em", lineHeight: 1, background: "linear-gradient(135deg, var(--brand-navy-800) 0%, var(--brand-navy-500) 55%, var(--brand-orange) 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>SAHU</span>
                <span style={{ fontSize: 16, fontWeight: 900, letterSpacing: "0.02em", lineHeight: 1, background: "linear-gradient(135deg, var(--brand-orange) 0%, var(--brand-orange-600) 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>CSC</span>
              </div>
              <span style={{ fontSize: 9, color: "var(--color-slate-400)", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", lineHeight: 1, marginTop: 2, display: "block" }}>
            ...
            <Link href="/notifications">
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span
                    className="absolute"
                    style={{ top: 7, right: 7, width: 8, height: 8, borderRadius: "50%", background: "var(--brand-orange)", border: "2px solid white", boxShadow: "0 0 6px rgba(249,115,22,0.5)" }}
                  />
                )}
              </button>
            </Link>
      ...
      {/* ── Navy greeting bar ──────────────────────────────────── */}
      <div style={{ background: "linear-gradient(90deg, var(--brand-navy-800) 0%, #1e3a8a 60%, var(--brand-navy-500) 100%)", padding: "0 16px", height: 40, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <LiveClock style={{ fontSize: 12, color: "white", fontWeight: 700, fontFamily: "monospace", background: "var(--brand-white-mid)", borderRadius: 6, padding: "2px 8px", letterSpacing: "0.05em" }} />
