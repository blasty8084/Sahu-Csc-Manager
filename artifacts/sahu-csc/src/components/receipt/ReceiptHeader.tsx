...
export function ReceiptHeader({ receiptNumber, shortDate }: ReceiptHeaderProps) {
  return (
    <>
      {/* ── Premium Navy Header ─────────────────────────────────────────────── */}
      <div style={{
        background: "linear-gradient(135deg, var(--brand-navy-800) 0%, #1a3f7a 55%, #071938 100%)",
        ...
        {/* Decorative circles */}
        <div style={{ position: "absolute", top: -20, right: -20, width: 88, height: 88, borderRadius: "50%", background: "var(--brand-orange-tint-sm)", pointerEvents: "none" }} />
        ...
        {/* Gold accent stripe */}
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 3, background: "linear-gradient(90deg, var(--brand-orange), #fcd34d 50%, var(--brand-orange))" }} />
      </div>
