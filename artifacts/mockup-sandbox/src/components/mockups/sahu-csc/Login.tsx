...
export function Login() {
  ...
  return (
    <div className="h-screen w-full flex flex-col overflow-hidden" style={{ background: "linear-gradient(160deg, #0B1340 0%, #0b2c60 55%, #1a3a7a 100%)" }}>
      ...
      {/* Top header */}
      <div className="flex-shrink-0 flex flex-col items-center pt-8 pb-4 px-6">
        {/* Logo */}
      ...
      <div className="flex-1 rounded-t-3xl overflow-hidden bg-white">
        <div className="h-full overflow-y-auto px-6 pt-6 pb-6">
          ...
          {/* Register CTA card */}
          <div
            className="mt-4 flex items-center gap-3 px-4 py-3.5 rounded-2xl border-2 border-dashed overflow-hidden relative"
          ...
          >
            ...
            <div className="relative flex-shrink-0 w-14 h-14 opacity-25">
              <div className="absolute inset-0 rounded-xl" style={{ background: "#93c5fd" }} />
              <div className="absolute inset-1 rounded-lg bg-white flex flex-col gap-1 p-1.5">
                <div className="h-1 rounded bg-blue-200 w-3/4" />
                <div className="h-1 rounded bg-blue-200 w-full" />
                <div className="h-1 rounded bg-blue-200 w-2/3" />
                <div className="h-1 rounded bg-blue-200 w-full" />
              </div>
              <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full flex items-center justify-center" style={{ background: "#0b2c60" }}>
          ...
          <div className="mt-5 flex items-center justify-center gap-1.5">
            ...
            <p className="text-xs text-gray-400">Trusted. Secure. Reliable.</p>
          </div>
