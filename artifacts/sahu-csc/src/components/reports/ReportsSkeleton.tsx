  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-2.5">
        {[0, 1, 2, 3].map((i) => (
          <div key={i} className="bg-white dark:bg-zinc-800 rounded-2xl overflow-hidden border border-border shadow-sm">
      ...
      <div className="bg-white dark:bg-zinc-800 rounded-2xl border border-border shadow-sm p-4 space-y-3">
